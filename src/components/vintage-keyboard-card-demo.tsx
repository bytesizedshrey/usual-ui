...
export default function VintageKeyboardCardDemo() {
  ...
  return (
    <CardContainer className="inter-var" containerClassName="py-0" maxTilt={6}>
      <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-96 h-auto rounded-xl p-4 border  ">
        ...
        >
          A high-fidelity mechanical keyboard with physical key press, sound, and haptic feedback.
        </CardItem>
        <CardItem
          translateZ="100"
          className="mt-3 flex w-full items-center justify-center pt-2"
        >
          <div className="[zoom:0.45]">
            <VintageKeyboard layout="compact" />
          </div>
        </CardItem>
