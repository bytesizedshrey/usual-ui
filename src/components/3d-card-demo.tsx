...
import ReceiptPrinterDemo from "@/components/ReceiptPrinterDemo";
...
export default function ThreeDCardDemo() {
  ...
  return (
    <CardContainer className="inter-var" containerClassName="py-0" maxTilt={5}>
      <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full min-w-0 sm:w-96 h-auto rounded-xl p-4 border  ">
        ...
        >
          A tactile skeuomorphic receipt printer with an animated print
          experience.
        </CardItem>
        <CardItem
          translateZ="100"
